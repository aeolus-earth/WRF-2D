...
This script creates a new comprehensive setup without modifying the existing setup_experiments_perturbed.py.

Creates:
1. 100 perturbed runs for noop and threshold models (1e-7, 1e-9, 1e-11)
...
def setup_comprehensive_perturbed_experiments(config):
    ...
    full_ensemble_models = [
        ...
        ('threshold_1e-07', 'encoder_model_threshold_1e-07.pt', 'decoder_model_threshold_1e-07.pt'),
        ('threshold_1e-09', 'encoder_model_threshold_1e-09.pt', 'decoder_model_threshold_1e-09.pt'),
    ...
    with open(summary_file, 'w') as f:
        ...
        f.write(f"  - threshold_1e-07 autoencoder\n")
        f.write(f"  - threshold_1e-09 autoencoder\n")
